...
define('CAMPAIGN_ID', "f401758c3bfc0594a2f761f7b0041d0e");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '44168121097744f4819b54518632bdfc');
define('MP_PARAM_NAME', '__mo');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'a380c7f87c9266885da37735c2479b1d');
define('CHECK_MCPROXY_VALUE', 'b66194ab36272af2fa232b17ee90456e593c471e99629d1b7005a9f0110df8bd');
